...
func (o *ResetOffsetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /dex/firehoses/{firehoseUrn}/reset] resetOffset", response, response.Code())
	}
}
...
// Code gets the status code for the reset offset o k response
func (o *ResetOffsetOK) Code() int {
	return 200
}
...
// Code gets the status code for the reset offset bad request response
func (o *ResetOffsetBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the reset offset not found response
func (o *ResetOffsetNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the reset offset internal server error response
func (o *ResetOffsetInternalServerError) Code() int {
	return 500
}
