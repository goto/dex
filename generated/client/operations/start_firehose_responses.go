...
func (o *StartFirehoseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /dex/firehoses/{firehoseUrn}/start] startFirehose", response, response.Code())
	}
}
...
// Code gets the status code for the start firehose o k response
func (o *StartFirehoseOK) Code() int {
	return 200
}
...
// Code gets the status code for the start firehose bad request response
func (o *StartFirehoseBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the start firehose not found response
func (o *StartFirehoseNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the start firehose internal server error response
func (o *StartFirehoseInternalServerError) Code() int {
	return 500
}
