...
func (o *ListAlertTemplatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /dex/alertTemplates] listAlertTemplates", response, response.Code())
	}
}
...
// Code gets the status code for the list alert templates o k response
func (o *ListAlertTemplatesOK) Code() int {
	return 200
}
...
// Code gets the status code for the list alert templates internal server error response
func (o *ListAlertTemplatesInternalServerError) Code() int {
	return 500
}
