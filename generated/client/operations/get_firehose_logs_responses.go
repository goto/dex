...
func (o *GetFirehoseLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /dex/firehoses/{firehoseUrn}/logs] getFirehoseLogs", response, response.Code())
	}
}
...
// Code gets the status code for the get firehose logs o k response
func (o *GetFirehoseLogsOK) Code() int {
	return 200
}
...
// Code gets the status code for the get firehose logs bad request response
func (o *GetFirehoseLogsBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the get firehose logs not found response
func (o *GetFirehoseLogsNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the get firehose logs internal server error response
func (o *GetFirehoseLogsInternalServerError) Code() int {
	return 500
}
