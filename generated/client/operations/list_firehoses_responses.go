...
func (o *ListFirehosesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /dex/firehoses] listFirehoses", response, response.Code())
	}
}
...
// Code gets the status code for the list firehoses o k response
func (o *ListFirehosesOK) Code() int {
	return 200
}
...
// Code gets the status code for the list firehoses internal server error response
func (o *ListFirehosesInternalServerError) Code() int {
	return 500
}
