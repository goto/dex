...
func (o *UpsertFirehoseAlertPolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /dex/firehoses/{firehoseUrn}/alertPolicy] upsertFirehoseAlertPolicy", response, response.Code())
	}
}
...
// Code gets the status code for the upsert firehose alert policy o k response
func (o *UpsertFirehoseAlertPolicyOK) Code() int {
	return 200
}
...
// Code gets the status code for the upsert firehose alert policy not found response
func (o *UpsertFirehoseAlertPolicyNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the upsert firehose alert policy internal server error response
func (o *UpsertFirehoseAlertPolicyInternalServerError) Code() int {
	return 500
}
