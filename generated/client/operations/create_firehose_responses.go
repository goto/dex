...
func (o *CreateFirehoseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /dex/firehoses] createFirehose", response, response.Code())
	}
}
...
// Code gets the status code for the create firehose created response
func (o *CreateFirehoseCreated) Code() int {
	return 201
}
...
// Code gets the status code for the create firehose bad request response
func (o *CreateFirehoseBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the create firehose conflict response
func (o *CreateFirehoseConflict) Code() int {
	return 409
}
...
// Code gets the status code for the create firehose internal server error response
func (o *CreateFirehoseInternalServerError) Code() int {
	return 500
}
