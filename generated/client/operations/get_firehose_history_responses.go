...
func (o *GetFirehoseHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /dex/firehoses/{firehoseUrn}/history] getFirehoseHistory", response, response.Code())
	}
}
...
// Code gets the status code for the get firehose history o k response
func (o *GetFirehoseHistoryOK) Code() int {
	return 200
}
...
// Code gets the status code for the get firehose history not found response
func (o *GetFirehoseHistoryNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the get firehose history internal server error response
func (o *GetFirehoseHistoryInternalServerError) Code() int {
	return 500
}
