...
func (o *StopFirehoseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /dex/firehoses/{firehoseUrn}/stop] stopFirehose", response, response.Code())
	}
}
...
// Code gets the status code for the stop firehose o k response
func (o *StopFirehoseOK) Code() int {
	return 200
}
...
// Code gets the status code for the stop firehose bad request response
func (o *StopFirehoseBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the stop firehose not found response
func (o *StopFirehoseNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the stop firehose internal server error response
func (o *StopFirehoseInternalServerError) Code() int {
	return 500
}
