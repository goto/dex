...
func (o *ScaleFirehoseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /dex/firehoses/{firehoseUrn}/scale] scaleFirehose", response, response.Code())
	}
}
...
// Code gets the status code for the scale firehose o k response
func (o *ScaleFirehoseOK) Code() int {
	return 200
}
...
// Code gets the status code for the scale firehose bad request response
func (o *ScaleFirehoseBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the scale firehose not found response
func (o *ScaleFirehoseNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the scale firehose internal server error response
func (o *ScaleFirehoseInternalServerError) Code() int {
	return 500
}
