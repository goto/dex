...
func (o *UpgradeFirehoseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /dex/firehoses/{firehoseUrn}/upgrade] upgradeFirehose", response, response.Code())
	}
}
...
// Code gets the status code for the upgrade firehose o k response
func (o *UpgradeFirehoseOK) Code() int {
	return 200
}
...
// Code gets the status code for the upgrade firehose not found response
func (o *UpgradeFirehoseNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the upgrade firehose internal server error response
func (o *UpgradeFirehoseInternalServerError) Code() int {
	return 500
}
