...
func (o *PartialUpdateFirehoseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PATCH /dex/firehoses/{firehoseUrn}] partialUpdateFirehose", response, response.Code())
	}
}
...
// Code gets the status code for the partial update firehose o k response
func (o *PartialUpdateFirehoseOK) Code() int {
	return 200
}
...
// Code gets the status code for the partial update firehose bad request response
func (o *PartialUpdateFirehoseBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the partial update firehose not found response
func (o *PartialUpdateFirehoseNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the partial update firehose internal server error response
func (o *PartialUpdateFirehoseInternalServerError) Code() int {
	return 500
}
