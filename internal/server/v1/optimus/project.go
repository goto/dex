...
func Routes(optimus optimusv1beta1rpc.JobSpecificationServiceClient) func(r chi.Router) {
	return func(r chi.Router) {
		r.Get("/projects/{project_name}/jobs/{job_name}", handleGetOptimus(optimus))
	}
}

func getOptimus(ctx context.Context, optimusClient optimusv1beta1rpc.JobSpecificationServiceClient, jobName, projectName string) (*optimusv1beta1.GetJobSpecificationResponse, error) {
